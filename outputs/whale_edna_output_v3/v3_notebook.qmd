...
subtitle: "A notebook for the v3 pipeline"
...
This notebook walks through **v3** of the pipeline that combines:
...
![Expected density surface (page 1).](_notebook_figs/sim_page-1.png){width=100%}
...
![True marginal relationships (page 2).](_notebook_figs/sim_page-2.png){width=100%}
...
![Water column effect (page 3).](_notebook_figs/sim_page-3.png){width=100%}
