...
# All paths in this notebook are resolved relative to the .qmd's own
...
This notebook documents what we found, in the order we found it —
...
This is what the notebook is really about. Eight PRs, each fixing
