...
v3 of the pipeline (see [the v3 vignette](../whale_edna_output_v3/v3_vignette.qmd))
...
![Simulated `log(λ)` at surface stations.](_vignette_figs/sim_page-1.png){width=80%}
...
![Per-station truth vs spatial covariates.](_vignette_figs/sim_page-2.png){width=100%}
