# =============================================================================
# scripts/plotHarborPorpoiseData.R
#
# Two-panel side-by-side figure for harbor porpoise
# (Phocoena phocoena), combining:
#
#   Left panel  — Line-transect effort + harbor porpoise sightings (sized by
#                 group_size; group sizes are small so a linear scale reads
#                 cleanly).
#   Right panel — MARVER1 metabarcoding sampling locations + harbor porpoise
#                 detections (sized by total target reads; sqrt-scaled
#                 point size).
#
...
# Output : figures/lt_edna_harbor_porpoise.png  (14 x 7 in, 200 dpi)
#
# Run from the project root:
#   Rscript scripts/plotHarborPorpoiseData.R
# =============================================================================
...
OUT_PNG <- "figures/lt_edna_harbor_porpoise.png"
...
# ---------------------------------------------------------------------------
# LT subsets — harbor porpoise sightings + all effort segments in the map
# ---------------------------------------------------------------------------
sights_sp <- sights |>
...
# ---------------------------------------------------------------------------
# Left panel — LT effort + sightings. Harbor porpoise group sizes are
# small (typically 1 – ~10) so a linear point-size scale reads cleanly.
# ---------------------------------------------------------------------------
