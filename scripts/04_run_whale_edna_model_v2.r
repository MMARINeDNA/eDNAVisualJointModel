...
#
# Compile stan/whale_edna_hsgp_v2.stan and fit it to the Stan data list built
# by scripts/03_format_stan_data_v2.r.
#
# Inputs:  outputs/whale_edna_output_v2/stan_data.rds
# Outputs: outputs/whale_edna_output_v2/whale_edna_fit.rds
# =============================================================================
