...
#
# Compile stan/whale_edna_hsgp_v4.1.stan and fit it to the Stan data list
# built by scripts/03_format_stan_data_v4.1.r.
#
# Inputs:  outputs/whale_edna_output_v4.1/stan_data.rds
# Outputs: outputs/whale_edna_output_v4.1/whale_edna_fit.rds
#          + CmdStan output files in outputs/whale_edna_output_v4.1/
#
# v4.1 sampling configuration (per v3.2 lessons):
...
mod <- cmdstan_model(
  "stan/whale_edna_hsgp_v4.1.stan",
