# =============================================================================
# simulate_whale_edna_v4.2.R
#
# v4.2 - applies v3.2 lessons to the realistic three-species sim:
...
#
# Changes from v4.1:
#   * Ole added changes to Ct sigma function.
#   * Ole reformulated the junk category so that it is retained in the mb_reads
