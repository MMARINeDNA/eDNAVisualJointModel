...
# and not the other.
prop_reduced_qpcr_rep <- 0 # set to 0 for testing
prop_reduced_mb_rep   <- 0 # set to 0 for testing
...
dir.create("outputs/whale_edna_output_vS3", showWarnings = FALSE, recursive = TRUE)
saveRDS(sim, "outputs/whale_edna_output_vS3/whale_edna_sim_vS3.rds")
