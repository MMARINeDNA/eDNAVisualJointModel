...
#
# Read the simulated eDNA data (outputs/whale_edna_output_v3.1/whale_edna_sim_v3.1.rds) and assemble
...
sim <- readRDS("outputs/whale_edna_output_v3.1/whale_edna_sim_v3.1.rds")
