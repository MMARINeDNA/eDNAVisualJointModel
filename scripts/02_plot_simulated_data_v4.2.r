# =============================================================================
# plot_simulated_data_v4.2.R
#
# Three-page summary of the v4.2 simulation (zero-mean GP, 3 species,
...
page1 <- wrap_plots(p_row1, nrow = 1) +
  ...
  plot_annotation(
    title    = "Simulated eDNA fields - v4.2 (zero-mean GP)",
...
page2 <- ggplot(page2_df, aes(x = axis_val, y = log_lambda, colour = species)) +
  ...
  labs(
    title    = "Per-station truth vs spatial covariates (v4.2)",
...
page3 <- wrap_plots(p_row3, nrow = 1) +
  plot_annotation(
    title    = "eDNA water column effect - v4.2",
...
# =============================================================================
out_pdf <- "outputs/whale_edna_output_v4.2/simulated_edna_fields_v4.2.pdf"
