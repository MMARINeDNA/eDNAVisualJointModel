...
#
# Three-row figure for the V4 simulation (SF to US/Canada border, rotated
# bathymetry, 300 stations × 3 sample depths with variable per-sample
# replication — ~20% of samples have only 1 or 2 qPCR / MB reps):
#
...
ggsave("outputs/simulated_edna_fields_v4.png", fig,
       width = 13, height = 18, dpi = 150, limitsize = FALSE)

cat("Saved outputs/simulated_edna_fields_v4.png\n")
