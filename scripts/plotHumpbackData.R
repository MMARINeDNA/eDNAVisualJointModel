# =============================================================================
# scripts/plotHumpbackData.R
#
# Two-panel side-by-side figure for humpback whale
# (Megaptera novaeangliae), combining:
#
...
#   Rscript scripts/plotHumpbackData.R
# =============================================================================
...
LT_SPCODE      <- 76L
MB_SPECIES     <- "Megaptera novaeangliae"

LAT_MIN <- 37.5
LON_MIN <- -130
LON_MAX <- -120

OUT_PNG <- "figures/lt_edna_humpback.png"
...
# ---------------------------------------------------------------------------
# Left panel — LT effort + sightings.  Humpback group sizes are 1 – 8 so
# a linear point-size scale is fine.
# ---------------------------------------------------------------------------
